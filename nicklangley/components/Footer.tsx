...
class Footer extends React.Component {
    render() {
        return (
            <footer className="d-flex flex-wrap justify-content-between align-items-center p-3 w-75 m-auto mb-4 rounded-4 navbar-dark bg-dark fixed-bottom">
                    <div className="col d-flex justify-content-left align-items-center">
                        ...
                        <span className="mx-3">&nbsp;&copy;&nbsp;{metadata.year} Nicholas Langley</span>
                    </div>
