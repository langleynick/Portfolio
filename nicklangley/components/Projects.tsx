    ...
    render() {
        return(
            ...
            {projectList.map(data => (
                <div className='row justify-content-center text-light fw-bold my-3' key={data.id}>
                    <div className='col-md-11 col-lg-6 bg-dark rounded-5 text-center'>
                        ...
                        <a href={data.githubUrl} role='button' target='_blank'className='btn btn-outline-secondary text-light fw-bold mb-3'>View my work</a>
                    </div>
                </div>
             ))}
            </div>
